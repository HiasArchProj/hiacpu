...
_HIA_SIM_RESULT_DIR=${HIA_SIM_RESULT_DIR:-"hia-sim-result"}
_CURRENT="$_HIA_SIM_RESULT_DIR"/all/"$_NOW"
mkdir -p "$_CURRENT"
ln -sfn "all/$_NOW" "$_HIA_SIM_RESULT_DIR/result"
...
echo "VCS emulator finished, result saved in $_HIA_SIM_RESULT_DIR/result"
